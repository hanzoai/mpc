...
<div class="container">
  ...
  <div class="protocols">
    ...
    <div class="protocol">
      ...
      <p>Quantum-Safe And Reliable. Combines BLS12-381 pairing-based signatures with Corona lattice for immediate and future-proof security.</p>
    </div>
    <div class="protocol">
      <h3>BLS</h3>
...
<div class="container">
  ...
  <div class="features">
    ...
    <div class="feature">
      ...
      <p>Corona lattice-based signatures and Quasar hybrid scheme provide protection against future quantum computer attacks at configurable security levels.</p>
    </div>
    <div class="feature">
...
<div class="container">
  ...
  <div class="features">
    ...
    <div class="feature">
      ...
      <p>LSSS share refresh and Corona proactive rotation ensure long-term security even if shares are periodically exposed. Generation-based key lifecycle.</p>
    </div>
    <div class="feature">
